...
# Trains model with Double Q-Learning
def train_model_double_alt(model,
                            target_model,
                            loaders, 
                            dset_sizes, 
                            config, 
...
#                 print(next_state_values * config['gamma'])
#                 print('Masked Next State Values')
#                 print((next_state_values * config['gamma']) * reward_mask.float())
